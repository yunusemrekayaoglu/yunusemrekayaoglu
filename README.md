...
<p align="center">
  I am a Data Engineer building and maintaining production ETL/ELT pipelines with Apache Airflow, Python, and SQL. I work on integrating multiple data sources into modern data platforms, and I contribute to Lakehouse initiatives using Apache Spark, dbt, and Apache Iceberg, along with metadata management and data quality practices via OpenMetadata. With a foundation in Statistics and Computer Science from <b>Karadeniz Technical University</b>, I bridge statistical modeling and robust data engineering solutions.
</p>
...
<div align="center">
  ...
  <a href="https://medium.com/@yunusemrekayaoglu" target="_blank">
...
- **Data Engineer @ Hangikredi** (Jan 2025 – Present) — Designing and maintaining 20+ production Apache Airflow DAGs, building pipelines across PostgreSQL, Elasticsearch, GA4, REST APIs, and MinIO, and contributing to a Lakehouse architecture with Spark, dbt, and Iceberg. Implementing metadata synchronization, business glossary, and data quality rules with OpenMetadata.
- **Data Engineering Intern @ Hangikredi** (Jul 2024 – Jan 2025) — Developed and improved ETL pipelines with Apache Airflow, Docker, and PostgreSQL.

---

### 🚀 What I'm Working On

- 🏗️ **Lakehouse Architecture:** Contributing to Lakehouse initiatives with Apache Spark, dbt, and Apache Iceberg.
- 🧭 **Data Governance:** Metadata synchronization, business glossary, and data quality rules with OpenMetadata.
- 🎓 **MSc Research:** Deepening my expertise in Statistics and Computer Science at KTÜ.
- 📊 **Applied ML:** Exploring recommendation systems and explainable AI for visual regression testing.

---

### 🧩 Featured Projects

- **Explainable Visual Regression Testing** — An explainable visual regression testing framework for web interfaces, combining block-level comparison, DeepSeek-OCR, and GPT-4o to generate semantic explanations of visual regressions.
- **AI-powered Recommendation System Optimization (TÜBİTAK 2209-A)** — Led a TÜBİTAK 2209-A research project on e-commerce recommendation systems, building ML models (XGBoost, LightGBM, CatBoost) with an interactive Streamlit application.
